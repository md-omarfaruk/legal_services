                    ...
                    <div class="col-lg-9 p-4 border rounded-3 shadow">
                        ...
                        <div class="basic-details" id="basicDetails">
                            ...
                            <div class="row rounded-2 bg-body-secondary mt-5 p-4">
                                ...
                                <div class="col next-btn text-md-end">
                                    <a class="icon-link p-2 text-white rounded-3" id="basicDetailsNextBtn" href="#">
                        ...
                        <div class="summary" id="summary">
                            ...
                            <div class="row rounded-2 bg-body-secondary mt-5 p-4">
                                ...
                                <div class="col next-btn text-md-end">
                                    <a class="icon-link p-2 text-white rounded-3" id="bookAppointment" href="<?php echo get_option('siteurl') . 'thank-you/'; ?>"><strong class="date-time">Book Appointment</strong>
                                        <i class="bi bi-arrow-right"></i>
                                    </a>
                                </div>
                            </div>
